...
public class Anuncio {
	...
	public Anuncio(String id,String titulo,String usuario_prop, ArrayList<String>usuario_dest, String cuerpo, String tipo) {this.id = id; this.titulo = titulo; this.usuario_prop = usuario_prop;this.usuario_dest = usuario_dest;this.cuerpo = cuerpo;this.tipo = tipo;}
